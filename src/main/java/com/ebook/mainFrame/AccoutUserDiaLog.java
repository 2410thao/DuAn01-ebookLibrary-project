...
public class AccoutUserDiaLog extends javax.swing.JDialog {
    ...
    private boolean checkForm() {
        if (!UtilityHelper.checkNullPass(lblMatKhau, txtMatKhau)) {
            return false;
        } else if (!UtilityHelper.checkNullPass(lblMatKhauMoi, txtMatKhauMoi)) {
            return false;
    ...
    private void DoiMatKhau() {
        ...
        String xacNhan = String.valueOf(txtXacNhanMatKhau.getPassword());
        if (ShareHelper.USER.getMatKhau().equals(matkhau)) {
            if (matKhauMoi.equals(xacNhan)) {
                ShareHelper.USER.setMatKhau(matKhauMoi);
                daoTaiKhoan.updateMatKhau(ShareHelper.USER);
                DialogHelper.confirm(this, "Đổi mật khẩu thành công");
            } else {
                DialogHelper.confirm(this, "Xác nhận không khớp");
            }
        } else {
            DialogHelper.confirm(this, "Đổi mật khẩu thất bại");
        }
    ...
    private void initComponents() {
        ...
        btnLuuThongTin.setText("Lưu Tài Khoản");
        ...
        btnLuuThongTin.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mouseEntered(java.awt.event.MouseEvent evt) {
                btnLuuThongTinMouseEntered(evt);
            }
            public void mouseExited(java.awt.event.MouseEvent evt) {
                btnLuuThongTinMouseExited(evt);
            }
        });
        ...
        panelRound3.add(btnLuuThongTin, new org.netbeans.lib.awtextra.AbsoluteConstraints(610, 280, 220, 40));
        ...
        panelRound3.add(lblXacNhan, new org.netbeans.lib.awtextra.AbsoluteConstraints(470, 120, -1, -1));

        lblMatKhauMoi.setFont(new java.awt.Font("Inter Medium", 0, 14)); // NOI18N
        lblMatKhauMoi.setText("Mật Khẩu Mới ");
        panelRound3.add(lblMatKhauMoi, new org.netbeans.lib.awtextra.AbsoluteConstraints(40, 120, -1, -1));
        ...
        panelRound3.add(lblMatKhau, new org.netbeans.lib.awtextra.AbsoluteConstraints(470, 20, -1, -1));
    ...
    private void btnLuuThongTinMouseEntered(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_btnLuuThongTinMouseEntered
        btnLuuThongTin.setBackground(new Color(68, 152, 87));
    }//GEN-LAST:event_btnLuuThongTinMouseEntered

    private void btnLuuThongTinMouseExited(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_btnLuuThongTinMouseExited
        btnLuuThongTin.setBackground(new Color(87, 170, 100));
    }//GEN-LAST:event_btnLuuThongTinMouseExited
